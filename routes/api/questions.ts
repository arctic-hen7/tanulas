...
export const handler = async (
  ...
  if (message.refusal) {
    ...
    // `QuestionsResponse` (see below). The `as string` here is a type assertion, telling TypeScript that,
    ...
    const response: QuestionsResponse = JSON.parse(message.content as string);
